...
namespace eSales.Services.Migrations
{
    ...
    [Migration("20240129221726_Intial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eSales.Services.Database.Dobavljaci", b =>
                {
            ...
            modelBuilder.Entity("eSales.Services.Database.IzlazStavke", b =>
                {
            ...
            modelBuilder.Entity("eSales.Services.Database.Izlazi", b =>
                {
                    b.Property<int>("IzlazId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eSales.Services.Database.JediniceMjere", b =>
                {
            ...
            modelBuilder.Entity("eSales.Services.Database.Korisnici", b =>
                {
                    b.Property<int>("KorisnikId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eSales.Services.Database.KorisniciUloge", b =>
                {
            ...
            modelBuilder.Entity("eSales.Services.Database.Kupci", b =>
                {
            ...
            modelBuilder.Entity("eSales.Services.Database.NarudzbaStavke", b =>
                {
            ...
            modelBuilder.Entity("eSales.Services.Database.Narudzbe", b =>
                {
                    b.Property<int>("NarudzbaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eSales.Services.Database.Ocjene", b =>
                {
            ...
            modelBuilder.Entity("eSales.Services.Database.Proizvodi", b =>
                {
                    b.Property<int>("ProizvodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eSales.Services.Database.Skladistum", b =>
                {
                    b.Property<int>("SkladisteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eSales.Services.Database.UlazStavke", b =>
                {
            ...
            modelBuilder.Entity("eSales.Services.Database.Ulazi", b =>
                {
                    b.Property<int>("UlazId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eSales.Services.Database.Uloge", b =>
                {
                    b.Property<int>("UlogaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eSales.Services.Database.VrsteProizvodum", b =>
                {
                    b.Property<int>("VrstaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eSales.Services.Database.IzlazStavke", b =>
                {
                    b.HasOne("eSales.Services.Database.Izlazi", "Izlaz")
                        .WithMany("IzlazStavkes")
                        .HasForeignKey("IzlazId")
                        .IsRequired()
                        .HasConstraintName("FK_IzlazStavke_Izlazi");

                    b.HasOne("eSales.Services.Database.Proizvodi", "Proizvod")
                        .WithMany("IzlazStavkes")
            ...
            modelBuilder.Entity("eSales.Services.Database.Izlazi", b =>
                {
                    b.HasOne("eSales.Services.Database.Korisnici", "Korisnik")
                        .WithMany("Izlazis")
                        .HasForeignKey("KorisnikId")
                        .IsRequired()
                        .HasConstraintName("FK_Izlazi_Korisnici");

                    b.HasOne("eSales.Services.Database.Narudzbe", "Narudzba")
                        .WithMany("Izlazis")
                        .HasForeignKey("NarudzbaId")
                        .HasConstraintName("FK_Izlazi_Narudzbe");

                    b.HasOne("eSales.Services.Database.Skladistum", "Skladiste")
                        .WithMany("Izlazis")
            ...
            modelBuilder.Entity("eSales.Services.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasOne("eSales.Services.Database.Uloge", "Uloga")
                        .WithMany("KorisniciUloges")
            ...
            modelBuilder.Entity("eSales.Services.Database.Narudzbe", b =>
                {
                    b.HasOne("eSales.Services.Database.Kupci", "Kupac")
                        .WithMany("Narudzbes")
            ...
            modelBuilder.Entity("eSales.Services.Database.Proizvodi", b =>
                {
                    b.HasOne("eSales.Services.Database.JediniceMjere", "JedinicaMjere")
                        .WithMany("Proizvodis")
                        .HasForeignKey("JedinicaMjereId")
                        .IsRequired()
                        .HasConstraintName("FK_Proizvodi_JediniceMjere");

                    b.HasOne("eSales.Services.Database.VrsteProizvodum", "Vrsta")
                        .WithMany("Proizvodis")
            ...
            modelBuilder.Entity("eSales.Services.Database.UlazStavke", b =>
                {
                    ...
                    b.HasOne("eSales.Services.Database.Ulazi", "Ulaz")
                        .WithMany("UlazStavkes")
            ...
            modelBuilder.Entity("eSales.Services.Database.Ulazi", b =>
                {
                    b.HasOne("eSales.Services.Database.Dobavljaci", "Dobavljac")
                        .WithMany("Ulazis")
